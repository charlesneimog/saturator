...
void saturator_tilde_addmethods(t_class *sat_class)
{
    ...
    class_addmethod(sat_class, (t_method)saturator_threshold, gensym("thresh"), A_FLOAT, 0);
    class_addmethod(sat_class, (t_method)saturator_attack, gensym("attack"), A_GIMME, 0);
    class_addmethod(sat_class, (t_method)saturator_release, gensym("release"), A_GIMME, 0);
    class_addmethod(sat_class, (t_method)saturator_order, gensym("order"), A_FLOAT, 0);
    class_addmethod(sat_class, (t_method)saturator_cheap, gensym("cheap"), A_FLOAT, 0);
    class_addmethod(sat_class, (t_method)saturator_autogain, gensym("autogain"), A_FLOAT, 0);
    class_addmethod(sat_class, (t_method)saturator_pushpull, gensym("pushpull"), 0);
...
{
	saturator_class = class_new(gensym("saturator"), (t_newmethod)saturator_new, 0,
        sizeof(t_saturator), 0, 0);
